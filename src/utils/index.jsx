...
export const Accordian = () => {
  return (
    <div className="hs-accordion-group">
      ...
      >
        <button
          className="hs-accordion-toggle hs-accordion-active:text-blue-600 group py-3 inline-flex items-center justify-between gap-x-3 w-full font-semibold text-left text-gray-800 transition hover:text-gray-500 dark:hs-accordion-active:text-blue-500 dark:text-gray-00 dark:hover:text-gray-400"
